...
int main(int argc, char** argv)
{
    ...
    // int array_size = SIMD_VECTOR_WIDTH * 24;
    ...
    // }
    // float stltime = (float)stm_sec(diff); 
    // diff = 0;
    // seed = 0x12345678;
    // for (int i = 0; i < NUMBER_OF_SORTS; i++)
    // {
    ...
    //     if(!verify(array, array_size)) printf("2fail\n");
    // }
    // float simdtime = (float)stm_sec(diff); 
    ...
    // printf("%f, ", stltime / simdtime);
    printf("%f ",thread1/thread1);
    printf("%f ",thread1/thread2);
    printf("%f ",thread1/thread4);
    printf("%f ",thread1/thread8);
    // printf("\n");
